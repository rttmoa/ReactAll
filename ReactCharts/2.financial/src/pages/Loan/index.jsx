          ...
          <ul className={styles.row}>
            <li>
              <div className={styles.title}>
                ...
                <span className={styles.percent}>{" "} 
                  [<SvgIcon icon='icon-icon-caret-up' className={styles.caretUpIcon}/>{`${overview.custCountComp}%`}]
                </span>
              </div>
            ...
            <li>
              <div className={styles.title}>
                <span>贷款笔数</span> 
                <span className={styles.percent}>{" "} 
                  [<SvgIcon icon='icon-icon-caret-up' className={styles.caretUpIcon}/>{`${overview.loanCountComp}%`}]
                </span>
              </div>
            ...
            <li>
              <div className={styles.title}>
                <span>逾期金额</span> 
                <span className={styles.percent}>{" "} 
                  [<SvgIcon icon='icon-caret-down' className={styles.caretDownIcon}/>{`${overview.overdueAmtComp}%`}]
                </span>
              </div>
