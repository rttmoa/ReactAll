...
const UseMemo = () => {
  ...
  return (
    <div>
      <h3>UseMemo</h3>
      <button onClick={() => { setname('baby张-' + nameNum++)}}>改名字</button>
      <button onClick={() => { setage('年龄-' + ageNum++) }}>改年龄</button>
      <p><b>UseMemo： {name}: {age}</b></p>
...
const Child = ({ age, name, children }) => {
  ...
  return (
    <div style={{ border: '1px solid',padding: '20px 40px' }}>
