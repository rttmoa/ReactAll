...
export function BlogPostLayout({ children, meta, slug, latestPosts }) {
  console.log("/layouts/BlogPostLayout 布局")
            ...
            <dl>
              ...
              <div className="sm:flex sm:flex-wrap sm:justify-center xl:block">
                ...
                {meta.authors.map((author) => (
                  <dd key={author.twitter} className="flex items-center font-medium mt-6 sm:mx-3 xl:mx-0" >
                    <img
                      src={author.avatar}
                      alt=""
...
export function getStaticProps() {
  return {
    props: {
      latestPosts: getAllPosts().slice(0, 3).map(({ slug, module: { meta } }) => {
