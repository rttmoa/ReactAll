...
class ListItem extends React.Component { 
    ...
    goDetail(data){
        ...
        // jsinvoke({ cmd: 'openUrl',data: { url: encodeURIComponent('http://localhost:8080/detail.html?id=' + data.id)}}, (val)=>{ console.log(val) });
    }
    render(){
...
export default connect(state =>({list: state.contentListReducer.list}), null)(ListItem);
