...
/** #### ? 从 steedos-config.yml获取配置  */
const config = getSteedosConfig();


export const getSettings = async () => { // 获取 root 配置信息
    let tenant = {
        name: "Steedos",
        logo_url: undefined,
      ...
      return {
        ...
        root_url: process.env.ROOT_URL   // http://127.0.0.1:4000
      }
}
...
// ! 获取 getMergedTenant && getSettings && getTenant 的返回结果
