...
export function PrimaryFeatures() {
  let [tabOrientation, setTabOrientation] = useState('horizontal') // !水平还是垂直方向
    ...
    <section id="features" aria-label="Features for running your books" className="relative overflow-hidden bg-blue-600 pt-20 pb-28 sm:py-32">
      ...
      <Container className="relative">
        ...
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display tracking-tight text-white   text-3xl sm:text-4xl md:text-5xl">
            可视化，更高效的开发方式
          </h2>
        ...
        {/* TODO: Tabs;  https://headlessui.com/react/tabs */}
        <Tab.Group as="div" className="mt-16 grid grid-cols-1 items-center gap-y-2 pt-10 sm:gap-y-6 md:mt-20 lg:grid-cols-12 lg:pt-0"
