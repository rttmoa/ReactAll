...
const aspectRatioMap: number[] = [0, 1, 2, 4 / 3, 16 / 9];
...
let imgURL =
  'https://img1.baidu.com/it/u=3485269656,617316610&fm=253&fmt=auto&app=138&f=JPEG?w=660&h=440';
    ...
    return (
      visable !== 0 && (
        <div
          ...
          style={{ display: visable !== 1 ? 'flex' : 'none' }}
        >
          <div className="cropper-modal-content">
            <div className="cropper-modal-header">
              裁切设置{' '}
              <span className="cropper-modal-close-btn" onClick={handleClose}>
                ✕
              </span>
            </div>
            <Cropper
            ...
            <div className="cropper-modal-footer">
              <div className="modal-cancel" onClick={handleCancel}>
                取消
              </div>
              <div className="modal-ok" onClick={handleOk}>
                确定
              </div>
            </div>
          </div>
    ...
    <div className="xi-cropper-wrap">
      ...
      <div className="xi-cropper-upload">
        ...
        <div className="xi-cropper-file">
          ...
          {cropData && (
            <span className="xi-cropper-del" onClick={handleDel}>
              ✕
            </span>
          )}
        </div>
